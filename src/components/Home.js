...
<div id="Home_Dashboard">
    ...
    <table className="table table-borderless">
            <tbody>
              <tr>
                <td><Link to={"/rental/new_rent"} ><a href="/rental/new_rent" className = {buttons_class}>Rentar Articulo </a></Link></td>
           {/*  <td><Link to={"/rental/find_article"} ><a href="/forms/addclient" className = {buttons_class}>Buscar Articulo </a></Link> </td> */}
              </tr>
              <tr>
                <td><Link to={"/forms/new_customer"} ><a href="/forms/new_customer" className = {buttons_class}>Agregar Cliente </a></Link></td>
                <td><Link to={"/forms/find_customer"} ><a href="/forms/find_customer" className = {buttons_class}>Buscar Cliente </a></Link></td>
              </tr>
              <tr>
